import{i as e}from"./registry-CJLgdOlc.js";import{t}from"./hava-durumu-D5Asr3wm.js";var n=[{id:`no67`,ad:`No. 67`},{id:`no100`,ad:`No. 100`},{id:`no500`,ad:`No. 500`},{id:`no777`,ad:`No. 777`}],r=[`On my way to the funfair — race you there.`,`The pool water is PERFECT today.`,`Just lost at Hoop Shot again. Rematch?`,`Meet me on the dance floor tonight.`,`Did you see the new pieces at Boutique 67?`,`Kart 67 lap record. It is mine now.`],i=`
...
`,a={telefon:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><rect x="7" y="2.5" width="10" height="19" rx="3"/><path d="M11 18.5h2"/></svg>`,mesaj:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12a8 8 0 0 1-8 8H4l2.4-2.7A8 8 0 1 1 21 12z"/></svg>`,kamera:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 8h3l2-2.5h6L17 8h3a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1z"/><circle cx="12" cy="14" r="3.4"/></svg>`,hava:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M7 17a5 5 0 1 1 1-9.9A6 6 0 1 1 18 17z"/><path d="M8 20.5v.01M12 21.5v.01M16 20.5v.01"/></svg>`,galeri:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="4.5" width="17" height="15" rx="2.5"/><circle cx="9" cy="10" r="1.6"/><path d="M4 17.5 9.5 13l4 3.5 3-2.5 3.5 3"/></svg>`};e(`boot`,e=>{if(typeof document>`u`)return;let o=document.createElement(`style`);o.textContent=i,document.head.appendChild(o);let s=new Map(n.map(e=>[e.id,[]])),c=0,l=[],u=document.createElement(`button`);u.id=`tf-dugme`,u.type=`button`,u.setAttribute(`aria-label`,`Phone`),u.innerHTML=`${a.telefon}<span id="tf-rozet"></span>`,document.body.appendChild(u);let d=u.querySelector(`#tf-rozet`),f=document.createElement(`div`);f.id=`tf-bildirim`,document.body.appendChild(f);let p=null;function m(e,t){f.innerHTML=`<b>${e}</b>${t}`,f.style.display=`block`,clearTimeout(p),p=setTimeout(()=>{f.style.display=`none`},7e3)}function h(){d.style.display=c>0?`flex`:`none`,d.textContent=c>9?`9+`:String(c)}let g=document.createElement(`div`);g.id=`telefon`,g.innerHTML=`
    ...
    </div>`,document.body.appendChild(g);let _=g.querySelector(`#tf-icerik`),v=g.querySelector(`#tf-saat`);setInterval(()=>{let e=new Date;v.textContent=`${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`},1e3);function y(){c=0,h(),_.innerHTML=`<div class="tf-baslik">67 Phone</div>`;let e=document.createElement(`div`);e.className=`tf-izgara`;let t=[[`Messages`,a.mesaj,x],[`Camera`,a.kamera,w],[`Weather`,a.hava,D],[`Photos`,a.galeri,T]];for(let[n,r,i]of t){let t=document.createElement(`button`);t.type=`button`,t.className=`tf-app`,t.innerHTML=`${r}<span>${n}</span>`,t.addEventListener(`click`,i),e.appendChild(t)}_.appendChild(e)}let b=e=>{let t=document.createElement(`button`);return t.type=`button`,t.className=`tf-geri`,t.textContent=`Back`,t.addEventListener(`click`,e),t};function x(){_.innerHTML=``,_.append(b(y));let e=document.createElement(`div`);e.className=`tf-baslik`,e.textContent=`Messages`,_.appendChild(e);for(let e of n){let t=document.createElement(`button`);t.type=`button`,t.className=`tf-kisi`;let n=s.get(e.id).at(-1);t.innerHTML=`${e.ad}<br><span style="font-weight:400;color:#6b7280;font-size:12px;">${n?n.metin.slice(0,34):`Say hi`}</span>`,t.addEventListener(`click`,()=>S(e)),_.appendChild(t)}}function S(e){_.innerHTML=``,_.append(b(x));let t=document.createElement(`div`);t.className=`tf-baslik`,t.textContent=e.ad,_.appendChild(t);let n=document.createElement(`div`);_.appendChild(n);let i=()=>{n.innerHTML=``;for(let t of s.get(e.id)){let e=document.createElement(`div`);e.className=`tf-balon ${t.benden?`ben`:`o`}`,e.textContent=t.metin,n.appendChild(e)}n.lastChild?.scrollIntoView?.({block:`nearest`})};i();let a=document.createElement(`div`);a.id=`tf-yaz`;let o=document.createElement(`input`);o.placeholder=`Message`,o.maxLength=90;let l=document.createElement(`button`);l.type=`button`,l.textContent=`Send`;let u=()=>{let t=o.value.trim();t&&(o.value=``,s.get(e.id).push({benden:!0,metin:t}),i(),setTimeout(()=>{let t=r[Math.floor(Math.random()*r.length)];s.get(e.id).push({benden:!1,metin:t}),g.classList.contains(`acik`)?i():(c+=1,h(),m(e.ad,t))},1400+Math.random()*1800))};l.addEventListener(`click`,u),o.addEventListener(`keydown`,e=>{e.stopPropagation(),e.key===`Enter`&&u()}),o.addEventListener(`keyup`,e=>e.stopPropagation()),a.append(o,l),_.appendChild(a)}function C(){let e=document.querySelector(`canvas`);if(!e)return null;try{let t=document.createElement(`canvas`),n=Math.min(1,900/e.width);return t.width=Math.round(e.width*n),t.height=Math.round(e.height*n),t.getContext(`2d`).drawImage(e,0,0,t.width,t.height),t.toDataURL(`image/jpeg`,.82)}catch{return null}}function w(){_.innerHTML=``,_.append(b(y));let t=document.createElement(`div`);t.className=`tf-baslik`,t.textContent=`Camera`;let n=document.createElement(`p`);n.className=`tf-not`,n.textContent=`Frames the park exactly as you see it. Photos land in the gallery.`;let r=document.createElement(`button`);r.type=`button`,r.className=`tf-buyuk`,r.textContent=`Take photo`,r.addEventListener(`click`,()=>{let t=C();if(!t){e.ui.toast(`The camera could not read the frame.`);return}l.unshift(t),l.length>10&&l.pop(),e.ui.toast(`Saved to Photos.`),T()}),_.append(t,n,r)}function T(){_.innerHTML=``,_.append(b(y));let e=document.createElement(`div`);if(e.className=`tf-baslik`,e.textContent=`Photos`,_.appendChild(e),!l.length){let e=document.createElement(`p`);e.className=`tf-not`,e.textContent=`No photos yet — the camera is one tap away.`,_.appendChild(e);return}for(let e of l){let t=document.createElement(`img`);t.src=e,t.className=`tf-foto`,t.alt=`Park photo`,_.appendChild(t)}}let E={gunes:`Sunny`,bulut:`Clouding over`,yagmur:`Raining`};function D(){_.innerHTML=``,_.append(b(y));let e=document.createElement(`div`);e.className=`tf-baslik`,e.textContent=`Weather`;let n=document.createElement(`p`);n.className=`tf-not`,n.style.fontSize=`15px`;let r=document.createElement(`p`);r.className=`tf-not`;let i=()=>{n.textContent=`67 Park — ${E[t.simdiki]||t.simdiki}`,r.textContent=`Next change in about ${Math.max(0,Math.round(t.kalan))} seconds.`};i();let a=setInterval(()=>{if(!document.body.contains(n)){clearInterval(a);return}i()},1e3);_.append(e,n,r)}function O(){g.classList.add(`acik`),y()}function k(){g.classList.remove(`acik`)}u.addEventListener(`click`,()=>{g.classList.contains(`acik`)?k():O()}),g.querySelector(`#tf-kapat`).addEventListener(`click`,k),window.addEventListener(`keydown`,e=>{e.code===`KeyP`&&!e.repeat&&e.target===document.body&&(g.classList.contains(`acik`)?k():O())}),t.dinleyiciler.add((t,n)=>{t===`uyari`&&(c+=1,h(),m(`Weather`,n.mesaj),e.bus.emit(`sfx`,`notify`))})},{replay:!0});